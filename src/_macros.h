#ifndef FCGIEV__BASE_H
#define FCGIEV__BASE_H
...
/* Align a value */
#define FE_ALIGN(value, size) (((value)+(size)-1)&~((size)-1))
/* Align to memory, counted in bytes */
#if __LP64__
  #define FE_ALIGN_M(value) FE_ALIGN(value, 8)
#else
  #define FE_ALIGN_M(value) FE_ALIGN(value, 4)
#endif

/* Module identifier, used in logging */
#define MOD_IDENT "fcgiev"
